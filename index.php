...
<head>
  ...
  <meta property="og:image" content="https://www.pequeno.eu/guia/images_guia/grande527.jpg"/>
...
<body>
  ...
  <div class="title">
    ...
    <p> <i class="material-icons">map</i> <a href="mapa.php">ver no mapa »</a></p>
  </div>
...
<div id="paginate" class="nav" >
  ...
  if ( $Cpage < $nbPages) {echo '<p><a class="pag-next" href="?p='.($Cpage+1).'">Seguinte »</a></p>';}?>
</div>
<!-- localiza -->
